...
namespace Cl.Intertrade.ActivPay.Helpers.Utils
{
    public class CuponGenerator
    {
        ...
        public CuponGenerator(int minimumLength = 8, int maximumLength = 15, int minimumLowerCaseChars = 1,
        ...
        {
            var lengthOfPassword = _randomSecure.Next(MinimumLength, MaximumLength);
